        ...
        private IEnumerator<float> RegenExplosive()
        {
            ...
            while (true)
            {
                ...
                if (Ply.Inventory.UserInventory.Items.Count != 8)
                {
                    ...
                    {
                        Ply.AddItem(ItemType.GrenadeHE);
                        Ply.ShowHint($"<color=yellow>Explosive Item Generated!</color>", 3);
                    }
                }
                else
                {
                    Ply.ShowHint($"<color=yellow>You would have regenerated an item here, but your inventory is full.</color>", 4);
                }
            }
        }
    }
